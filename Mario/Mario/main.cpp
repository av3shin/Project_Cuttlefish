...
#include "allegro5\allegro_image.h" //importing the necessary allegro headers
...
//-------------------------------------------------------------------------------------------------------------
// Entity Function Creation and Other Null Pointers: Start
//-------------------------------------------------------------------------------------------------------------
...
ALLEGRO_BITMAP *image1 = NULL;//Blocks
int image1Height = 0;
int image1Width = 0;

ALLEGRO_BITMAP *image2 = NULL;//Shrooms
int image2Height = 0;
int image2Width = 0;

ALLEGRO_BITMAP *image3 = NULL;//Flying eyeball things Right
int image3Height = 0;
int image3Width = 0;

ALLEGRO_BITMAP *image4 = NULL;//Flying eyeball things Left
int image4Height = 0;
int image4Width = 0;
...
int pointer = 400;
//-------------------------------------------------------------------------------------------------------------
// Entity Function Creation and Other Null Pointers: End
//-------------------------------------------------------------------------------------------------------------
...
int main(void)
{
	...
	WALLimage = al_load_bitmap("pause1.jpg");//pause screen
	WALL2image = al_load_bitmap("start.jpg");//start screen


	WALLDimage = al_load_bitmap("pause2.jpg");//pause screen DEMO
	WALL2Dimage = al_load_bitmap("quit.jpg");//start screen DEMO

	WALLQimage = al_load_bitmap("pause3.jpg");//pause screen QUIT
	WALL2Qimage = al_load_bitmap("quit2.jpg");//start screen QUIT
