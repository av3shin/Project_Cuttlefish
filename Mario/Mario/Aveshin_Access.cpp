...
int main()
{
	...
	al_draw_text(font_type, al_map_rgb(255, 20, 23), 400, 300, ALLEGRO_ALIGN_CENTER, "Aveshin Naidoo");
	al_draw_text(font_type, al_map_rgb(255, 20, 23), 400, 320, ALLEGRO_ALIGN_CENTER, "214547465");
